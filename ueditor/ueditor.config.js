...
(function () {
     ...
     * window.UEDITOR_HOME_URL = "/xxxx/xxxx/";
	 URL ="http://www.scimi.hk/system/";
     */
	//window.UEDITOR_HOME_URL||"/http://www.tv373.com/manager_list/ueditor";
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:""                                //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置,imagePath:URL + "php/"
        ...
        ,scrawlPath:""                            //图片修正地址，同imagePath,scrawlPath:URL+"php/"

        //附件上传配置区
        ,fileUrl:URL+"php/fileUp.php"               //附件上传提交地址
        ,filePath:""                   //附件修正地址，同imagePath,filePath:URL + "php/"
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"php/getRemoteImage.php"   //处理远程图片抓取的地址
        ,catcherPath:""                  //图片修正地址，同imagePath,catcherPath:URL + "php/"
